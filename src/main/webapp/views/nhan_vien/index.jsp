        ...
        <c:if test="${f:length(listNv) != 0}">
            ...
            <c:forEach items="${listNv}" var="nv">
                <tr class="">
                    ...
                    <td scope="row">
                        <a class="btn btn-primary" href="/Assignment_PH23038_war_exploded/nhan-vien/edit?ma=${nv.ma}">
                            Edit
                        </a>
                        <a class="btn btn-danger" href="/Assignment_PH23038_war_exploded/nhan-vien/delete?ma=${nv.ma}">
                            Delete
                        </a>
                    </td>
                </tr>
